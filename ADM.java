...
public class ADM extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ninfo!=null && ninfo.isConnected()) {
                    wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_VHotSDVOQkhtcjg");
                }
                    else
                    {
                        Toast.makeText(ADM.this, "No Internet Connection", Toast.LENGTH_LONG).show();
                    }
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    if(ninfo!=null && ninfo.isConnected()) {
                        wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_ZTBWTElzX2drb1U");
                    }
                        else
                        {
                            Toast.makeText(ADM.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    if(ninfo!=null && ninfo.isConnected()) {
                        wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_OS1mcGlnZGZfVmc");
                    }
                        else
                        {
                            Toast.makeText(ADM.this, "No Internet Connection", Toast.LENGTH_LONG).show();
