...
public class FOM extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_NmNIMUUwTngwWFU");
                }
                else
                {
                    Toast.makeText(FOM.this, "No Internet Connection", Toast.LENGTH_LONG).show();
                }
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_Ym43bHlOS09jakE");
        }
        else
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_VnRneEpCdDRJRUk");
        }
        else
        {
        Toast.makeText(FOM.this, "No Internet Connection", Toast.LENGTH_LONG).show();
