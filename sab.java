    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ninfo!=null && ninfo.isConnected()) {
                    ...
                    wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_SGtmd0NRVzEzUEU");
                }
                else
                {
                    Toast.makeText(sab.this, "No Internet Connection", Toast.LENGTH_LONG).show();
                }
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_aVVTeTAwSU5JbnM");
                    }
                    else
                    {
                        Toast.makeText(sab.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wb.loadUrl("https://drive.google.com/open?id=0BySpcum8uic_eEFHTER0d0dQbWs");
        }
        else
        {
        Toast.makeText(sab.this, "No Internet Connection", Toast.LENGTH_LONG).show();
